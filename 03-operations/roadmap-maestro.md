...
|---|---|---|---|
| 1 | **Embudo de ventas multi-servicio (no solo becas)** | ✅ **100% completo (2026-07)** — ver [`02-sales/manual-embudo-ventas.md`](../02-sales/manual-embudo-ventas.md), el documento maestro que conecta todo con 4 ejemplos completos paso a paso (Becas, Team Experience, International Program, Colegio). Incluye fichas por servicio, activos de autoridad (pendiente material real), propuesta escrita, cadencia de seguimiento, y pasos exactos de Calendly. **Única acción manual pendiente de Joel:** crear los Event Types en su cuenta de Calendly siguiendo los pasos ya dados | Ya hay leads reales entrando y **0 cerrados** — es una fuga activa, más barata de arreglar que conseguir leads nuevos |
