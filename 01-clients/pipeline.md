# Pipeline (CRM ligero, en texto)

> MVP de CRM sin herramientas externas — mientras el volumen no justifique migrar a Airtable u otra herramienta. Actualizar cada vez que haya movimiento. Ver [lineas-de-negocio.md](../00-company/lineas-de-negocio.md).

## Team & Coach Experience — prospectos y clientes
...
## Becas deportivas — prospectos y clientes

| Nombre | Servicio | Estado | Detalle |
|---|---|---|---|
...
|---|---|---|---|
| Atlético de Madrid | Club anfitrión | Vía contacto del padre de Joel | Acuerdo firmado y activo |
| Real Sociedad | Club anfitrión + International Program | Vía ex-jugador, contacto del padre | Acuerdo firmado y activo. Ver [lineas-de-negocio.md](../00-company/lineas-de-negocio.md) línea 3 |
| Sporting de Gijón | Club anfitrión | Vía red del padre | Acuerdo firmado y activo |
| David (Rueda) | CEO University Soccer, becas + Alemania/España | Relación directa de Joel | Acuerdo 50/50 por jugador firmado (universidad o colegio vía GEE) |
